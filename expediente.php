        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name=" peso" id="peso" class="form-control" pattern="[0-9Kg.]+" title="Coloca el peso del paciente con su respectiva unidad de medida (Kg)" maxlength="6" placeholder="Ej. 1.20Kg">
                </div>
            </div>

            <div class="col">
                 <label for="Altura">Altura: </label>
                 <input type="text" name="Altura" id="altura" class="form-control" pattern="[0-9m.]+" title="Coloca la altura del paciente con su respectiva unidad de medida (m)" placeholder="Ej. 1.50m">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <textarea name="Antecedentes" id="antecedente" class="form-control"></textarea>
                </div>
            </div>
