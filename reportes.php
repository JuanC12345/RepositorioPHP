    ...
    <div class="container">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                   ...
                                   <center><i class="fas fa-heartbeat fa-6x" id="logo1"></i></center><br>
                                    <div class="card-body">
                                        <form action="impresion_reportes.php" method="POST" style="width: 545px; margin: auto;">

         <div class="form-group">
            <label for="Nombre">Nombre Del Paciente: </label>
            <select name="paciente" id="Nombre" class="form-control ">
        ...
        $conexion = mysqli_connect("localhost","root","","consultorioclinico") or die ("Error en la conexión con la Base de Datos");
              ...
              /* $query = "Select T1.Id_Paciente, T1.Nombre, T1.Apellido, T2.Id_cita from Paciente T1 INNER JOIN cita T2 ON T1.Id_Paciente = T2.Id_Paciente";*/
                ...
                $query = "Select Nombre, Apellido FROM paciente";
