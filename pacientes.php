...
<?php
        ...
        if (isset($_POST) && !empty($_POST)) {
            ...
            $res = $usuario->createPatient($Nombre, $Apellido, $Direccion, $DUI, $Telefono, $Edad, $Sexo);
...
<body>
    ...
    <div class="container">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="Nombre" id="nom" class="form-control" placeholder="Ej.Jose Alfredo">
            ...
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="Apellido" id="ape" class="form-control" placeholder="Ej.Marroquin Lazo">
                    <small class="form-text text-muted">
                        Apellido Porfavor.
                    </small>
                </div>
    ...
    <label for="Direccion">Direccion: </label>
                    <input type="text" name="Direccion" id="dir" class="form-control" placeholder="Ej.CA 1W, San Salvador">
                    <small class="form-text text-muted">
                        Ingrese Su Direccion
                    </small>

    <label for="DUI">DUI: </label>
                    <input type="text" name="DUI" id="DUI" class="form-control" placeholder="Ej.04589638-4">
                    <small class="form-text text-muted">
                        Ingrese El DUI del paciente
                    </small>
    <label for="telefono" >Telefono: </label>

<input type="text" name="telefono" id="tel" class="form-control" placeholder="Ej.7154-3856">
                    <small class="form-text text-muted">
...
<div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="text" name="Edad" id="edad" class="form-control" placeholder="Ej. 18">
                    <small class="form-text text-muted">
            ...
            <select name="Sexo" id="Sexo" class="form-control">
             ...
             <button type="submit" class="btn btn-primary" id="b1">Crear Paciente</button>
        </div>
