                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li>
                            <a class="nav-link" href="#"><i class="fas fa-file-alt"></i>Impresion Recetas</a>
                        </li>
    ...
    <div class="container">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                   ...
                                   <center><i class="fas fa-heartbeat fa-6x" id="logo1"></i></center><br>
                                    <div class="card-body">
                                         <form action="impresion_recetas.php" method="POST" style="width: 545px; margin: auto;">

         <div class="form-group">
            <label for="Nombre">Titulo De Receta: </label>
            <select name="receta" id="Nombre" class="form-control ">
                   <option disabled selected>Seleccione un Titulo</option>
                <?php
        ...
        $conexion = mysqli_connect("localhost","root","","consultorioclinico") or die ("Error en la conexión con la Base de Datos");
              ...
              /* $query = "Select T1.Id_Paciente, T1.Nombre, T1.Apellido, T2.Id_cita from Paciente T1 INNER JOIN cita T2 ON T1.Id_Paciente = T2.Id_Paciente";*/
                ...
                $query = "Select Titulo FROM receta";
...
<br>
<button type="submit" class="btn btn-primary" id="b3">Imprimir Recetas.</button>
