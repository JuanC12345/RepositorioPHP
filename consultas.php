...
<body>
    ...
    <div class="container">
         ...
         <div class="form-group">
            ...
            <textarea id="Medicamentos" placeholder="Medicamentos Indicados" class="form-control"></textarea>
            <br>
            <label for="Dosis">Dosis Indicada: </label>
            <textarea id="Dosis" placeholder="Dosis A Tomar" class="form-control"></textarea>
           </div>
