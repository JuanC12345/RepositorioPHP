...
if (isset($_POST) && !empty($_POST)) {
    ...
    $Nombre  = $usuario->sanitize($_POST['patient']);
    $Nombre_Doctor = $usuario->sanitize($_POST['doctor']);
    $Fecha  = $usuario->sanitize($_POST['Fecha']);
    $Hora  = $usuario->sanitize($_POST['Hora']);
    $Estado = $usuario->sanitize($_POST['status']);
    
    $ID = intval($_POST['id_quote']);

    $res = $usuario->updateQuote($Nombre, $Nombre_Doctor, $Fecha, $Hora,$Estado,$ID);
...
$datos_usuario = $usuario->single_record_Quote($id);
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="citaRead.php"><i class="fas fa-address-book"></i>Gestionar Citas</a>
                            </li>
...
<form action="#" method="POST" style="width: 545px; margin: auto;">
         ...
         <div class="form-group">
            ...
            <select name="patient" id="gender" class="form-control">
        ...
        $conexion = mysqli_connect("localhost","root","","consultorioclinico") or die ("Error en la conexión con la Base de Datos");
            ...
            <select name="doctor" id="gender" class="form-control">
                 <option value=<?php echo $datos_usuario->Id_Doctor?>><?php echo $datos_usuario->Nombre_Doctor." ".$datos_usuario->Apellido_Doctor?></option>
        ...
        $conexion = mysqli_connect("localhost","root","","consultorioclinico") or die ("Error en la conexión con la Base de Datos");
                ...
                while (($row = mysqli_fetch_array($result)) != NULL) {
                    if ($datos_usuario->Id_Doctor==$row["Id_Doctor"]) {
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    ...
                    <input type="date" name=" Fecha" id="Hora" class="form-control" value="<?php echo $datos_usuario->Fecha_Cita; ?>">
                    <input type="hidden" name="id_quote" id="id_paciente" class='form-control' maxlength="100" value="<?php echo $datos_usuario->Id_Cita; ?>">
                </div>
...
<br>
            <div class="col">
                 ...
                 <input type="time" name="Hora" id="Hora" class="form-control" value="<?php echo $datos_usuario->Hora; ?>">
         ...
         <div class="form-group">
            <label for="patient">Estado de la cita </label>
